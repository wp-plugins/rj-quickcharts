<?
wp_enqueue_style('rjqc-styles', plugins_url('/rj-charts/main.css'));
...
<div id="wpbody-content" class="rjqc-admin" aria-label="Main content" tabindex="0">
    <div class="wrap">
        ...
        <h2>
            Edit Charts <a class="button add-new-h2" href="admin.php?page=rj-charts/admin/rjqc-admin-new.php">Add New</a>
        </h2><br />
                ...
                foreach ($charts as $chart) {
                    ...
                    <tr class="author-self status-inherit" valign="top">
                        ...
                        <td class="column-title">
                            <strong>
                                <a class="row-title" href="admin.php?page=rj-charts/admin/rjqc-admin-new.php&amp;id='.$chart->id.'" title="Edit">'.$chart->title.'</a>
                            </strong>
                            <div class="row-actions">
                                <span class="edit">
                                    <a title="Edit this chart" href="admin.php?page=rj-charts/admin/rjqc-admin-new.php&amp;id='.$chart->id.'">Edit</a> |
                                </span>
